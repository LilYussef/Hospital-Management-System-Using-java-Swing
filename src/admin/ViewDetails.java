    ...
    ViewDetails(String id) {
        ...
        try {
            ...
            if (!res.next()) {
                ...
                while (res.next()) {
                    id_txt.setText(id);
                    name_txt.setText(res.getString("name"));
                    age_txt.setText(res.getString("age"));
                    phno_txt.setText(res.getString("ph_no"));
                    address_txt.setText(res.getString("address"));
                    dist_jcb.setText(res.getString("district"));
                    apt_date.setText(res.getDate("appointment").toString());
                    bldgrp_jcb.setText(res.getString("bloodgrp"));
                    doctName_jcb.setText(res.getString("doctor"));
                    symp_txt.setText(res.getString("symptoms"));
