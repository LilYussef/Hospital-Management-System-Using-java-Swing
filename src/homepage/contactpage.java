...
public class contactpage extends JFrame {
    ...
    contactpage(){
        ...
        jsp=new JSplitPane();
        co.add(jsp);
        mail= new JButton("yuossefhilmy@gmail.com");
    ...
    pane.add(about);  
         ...
         head.setBounds(300,30, 250, 35);
         head.setForeground(Color.decode("#29aae1"));
         p2.add(head);
         
         String text="<html><p><center> ADDRESS <br> 239,hospital management system, alex, Egy.<br><br>" + " Phone Number<br> +20 1095798212 <br><br>" + "E-mail ID<br><br></center>.</p></html>";
